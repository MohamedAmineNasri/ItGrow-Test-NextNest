  ...
  return (
    <div className="flex flex-col justify-center items-center gap-[48px] w-full bg-[#F7F8FA] py-8">
      <div className="relative flex flex-col items-center gap-2 w-full px-4">
        <div className="absolute w-[60px] h-[60px] left-[1100px] top-[-9px] bg-[rgba(51,231,175,0.1)] rounded-[30px] z-0"></div>
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1  px-4 md:w-full lg:w-[1400px] justify-items-center">
        <div className="flex flex-col items-center px-[20px] py-[30px] gap-[25px] bg-[#FFFFFF] rounded-md max-w-xs w-full">
          ...
          <div className="flex items-center px-0 py-[40px]">
            <p className="font-jost font-medium text-[42px] text-[#11204D]">
              $
            </p>
            <p className="font-jost font-medium text-[68px] text-[#11204D]">
              99
            </p>
          </div>
          ...
          <div className="flex flex-col justify-center items-center gap-[10px]">
            <p className="font-jost text-[17px] text-[#11204D]/[0.7]">
              1 Hour Photography
            </p>
            <p className="font-jost text-[17px] text-[#11204D]/[0.7]">
              60 - 100 images / shoot
        ...
        <div className="flex flex-col  items-center px-[20px] py-[30px] gap-[25px] bg-[#6138BD33] rounded-md max-w-xs w-full shadow-[0px_8px_12px_rgba(97,_56,_189,_0.2)]">
          ...
          <div className="flex items-center px-0 py-[40px]">
            <p className="font-jost font-medium text-[42px] text-[#6138BD]">
              $
            </p>
            <p className="font-jost font-medium text-[68px] text-[#6138BD]">
              199
            </p>
          </div>
          <p className="font-jost font-medium text-[17px] text-[#11204D]">
